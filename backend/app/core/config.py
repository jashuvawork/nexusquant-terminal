...
class Settings(BaseSettings):
    ...
    paper_scalp_micro_partial_points: float = 2.0
    ...
    paper_quick_profit_max_lots: int = 16
    paper_quick_profit_allocation_boost: float = 1.5
    ...
    paper_swing_min_lots: int = 4
    paper_swing_target_lots: int = 6
    paper_swing_max_lots: int = 8
    paper_swing_max_loss_inr: float = 8000.0
