...
class Settings(BaseSettings):
    ...
    trading_capital_default: float = 200000.0
    ...
    paper_max_trade_loss_amount: float = 12000.0
    paper_max_open_trades: int = 1
    paper_max_open_same_side_trades: int = 3
    paper_dual_capital_enabled: bool = True
    paper_scalping_capital: float = 170000.0
    paper_explosive_capital: float = 30000.0
    paper_scalping_max_open_trades: int = 1
    paper_explosive_max_open_trades: int = 1
    paper_scalping_allocation_pct: float = 85.0
    ...
    paper_acs_scalp_enabled: bool = False
    ...
    paper_scalp_partial_exit_points: float = 5.0
    paper_scalp_partial_exit_pct: float = 0.65
    paper_scalp_partial_remainder_stop_points: float = 2.0
    paper_scalp_reluctant_profit_enabled: bool = True
    paper_scalp_micro_partial_points: float = 4.0
    paper_scalp_micro_partial_pct: float = 0.55
    paper_scalp_grind_profit_seconds: float = 90.0
    paper_scalp_grind_profit_min_gain: float = 2.0
    paper_scalp_stale_giveback_points: float = 1.5
    paper_scalp_stale_min_best_gain: float = 3.0
    paper_scalp_stale_min_unrealized: float = 1.5
    paper_scalp_fade_lane_enabled: bool = True
    paper_scalp_kelly_sizing_enabled: bool = False
    paper_scalp_ml_exit_overlay_enabled: bool = False
    paper_scalp_ml_exit_min_unrealized_points: float = 4.0
    paper_scalp_ml_exit_min_best_gain_points: float = 3.0
    paper_scalp_ml_exit_score_threshold: float = 75.0
    ...
    paper_quick_profit_min_lots: int = 100
    paper_quick_profit_target_lots: int = 100
    paper_quick_profit_max_lots: int = 100
    paper_quick_profit_allocation_boost: float = 1.65
    ...
    paper_daily_profit_target_amount: float = 20000.0
    ...
    paper_elite_runner_only: bool = False
    ...
    paper_scalp_red_streak_pause_losses: int = 5
    paper_scalp_red_streak_min_pf: float = 1.0
    paper_scalp_red_streak_rolling_trades: int = 3
    paper_scalp_red_streak_dead_entries: int = 4
    paper_scalp_loss_streak_lot_cap: int = 18
    paper_scalp_loss_streak_lot_cap_after: int = 3
    paper_scalp_loss_streak_pf_cap: float = 0.0
    ...
    paper_dual_scalp_min_lots: int = 20
    paper_dual_scalp_target_lots: int = 22
    paper_dual_scalp_max_lots: int = 26
    paper_dual_scalp_max_loss_inr: float = 12000.0
    paper_dual_scalp_min_velocity_pct: float = 1.5
    paper_dual_explosive_min_lots: int = 20
    paper_dual_explosive_target_lots: int = 22
    paper_dual_explosive_max_lots: int = 24
    ...
    paper_simple_micro_target_points: float = 5.0
    paper_simple_micro_trail_points: float = 1.25
    paper_simple_min_lots: int = 100
    paper_simple_target_lots: int = 100
    paper_simple_max_lots: int = 100
    ...
    paper_reference_runner_extend_best_gain: float = 8.0
    paper_reference_runner_target_points: float = 27.0
    paper_reference_target_points: float = 12.0
    paper_reference_stop_points: float = 3.2
    paper_reference_micro_arm_points: float = 3.0
    ...
    paper_reference_emergency_loss_inr: float = 8800.0
    paper_reference_runner_emit_limit: int = 8
    paper_reference_max_loss_inr: float = 12000.0
    paper_reference_max_open_trades: int = 6
    paper_reference_max_open_same_side: int = 4
    paper_reference_side_switch_enabled: bool = True
    paper_reference_side_switch_min_confidence: float = 62.0
    paper_reference_confidence_scale_enabled: bool = True
    paper_reference_confidence_full_pct: float = 82.0
    paper_reference_confidence_mid_pct: float = 65.0
    paper_reference_scale_min_lots: int = 50
    paper_reference_scale_mid_lots: int = 75
    paper_reference_duplicate_cooldown_seconds: int = 15
    paper_reference_same_side_entry_cooldown_seconds: int = 60
    paper_reference_same_side_loss_cooldown_seconds: int = 120
    paper_unified_strategy_router: bool = True
    paper_swing_trading_enabled: bool = False
    paper_swing_min_runner_score: float = 78.0
    paper_swing_min_velocity_pct: float = 1.2
    paper_swing_max_velocity_pct: float = 4.5
    paper_swing_midday_min_score: float = 82.0
    paper_swing_target_points: float = 14.0
    paper_swing_stop_points: float = 5.0
    paper_swing_min_hold_seconds: int = 120
    paper_swing_max_hold_seconds: int = 600
    paper_swing_trail_arm_points: float = 6.0
    paper_swing_trail_retain_pct: float = 0.65
    paper_swing_partial_points: float = 8.0
    paper_swing_partial_pct: float = 0.45
    paper_swing_min_lots: int = 20
    paper_swing_target_lots: int = 22
    paper_swing_max_lots: int = 26
    paper_swing_max_loss_inr: float = 15000.0
    paper_swing_max_open_trades: int = 1
    ...
    paper_runner_max_allocation_pct: float = 85.0
