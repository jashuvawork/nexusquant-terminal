...
class Settings(BaseSettings):
    ...
    explosive_runner_momentum_min_score: float = 50.0
    ...
    paper_scalping_allocation_pct: float = 15.0
    ...
    paper_max_catch_min_runner_score: float = 70.0
    paper_max_catch_runner_emit_limit: int = 4
    paper_high_confidence_only: bool = False
