...
class Settings(BaseSettings):
    ...
    paper_acs_quick_profit_points: float = 5.5
    paper_scalp_time_lock_seconds: int = 75
    paper_scalp_time_lock_min_gain: float = 3.0
    ...
    paper_scalp_micro_arm_points: float = 1.2
    paper_scalp_micro_trail_points: float = 0.5
    ...
    paper_scalp_ev_min_profit_factor: float = 1.0
    ...
    paper_scalp_micro_partial_points: float = 1.2
    ...
    paper_scalp_loss_streak_lot_cap: int = 8
    ...
    paper_simple_target_points: float = 4.0
    paper_simple_stop_points: float = 3.0
    paper_simple_min_hold_seconds: float = 30.0
    paper_simple_max_hold_seconds: float = 180.0
    paper_simple_trail_arm_points: float = 2.0
    paper_simple_trail_retain_pct: float = 0.50
    paper_simple_min_lots: int = 2
    paper_simple_target_lots: int = 4
    paper_simple_max_lots: int = 6
    paper_simple_max_loss_inr: float = 2500.0
    paper_simple_emergency_loss_inr: float = 4000.0
