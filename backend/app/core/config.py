...
class Settings(BaseSettings):
    ...
    paper_scalp_runner_arm_points: float = 5.0
    paper_scalp_runner_min_lock_points: float = 2.5
    paper_scalp_runner_retain_pct: float = 0.58
    paper_scalp_runner_cap_points: float = 12.0
    paper_scalp_micro_arm_points: float = 4.0
    paper_scalp_micro_trail_points: float = 1.25
