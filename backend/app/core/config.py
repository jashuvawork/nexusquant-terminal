...
class Settings(BaseSettings):
    ...
    paper_scalp_relaxed_sessions: str = "MIDDAY_CHOP,NORMAL"
    ...
    paper_scalp_cross_index_min: int = 2
    ...
    paper_scalp_partial_exit_pct: float = 0.55
    paper_scalp_partial_remainder_stop_points: float = 1.5
    ...
    paper_quick_profit_target_lots: int = 12
    paper_quick_profit_max_lots: int = 18
    paper_quick_profit_allocation_boost: float = 1.9
    paper_quick_profit_risk_unit_points: float = 3.0
    paper_quick_profit_risk_budget_amount: float = 20000.0
