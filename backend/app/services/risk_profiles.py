...
def _scalp_acs_session_params(bucket: str, *, block_closing_momentum: bool = False) -> dict[str, Any]:
    ...
    overrides: dict[str, dict[str, Any]] = {
        "MIDDAY_CHOP": {
            ...
            "grindProfitMinGain": 0.9,
            "staleGivebackPoints": 0.9,
            "staleMinBestGain": 1.8,
            "decaySeconds": 50.0,
            "decayMinGain": 0.5,
        },
        "NORMAL": {
            ...
            "partialExitPct": 0.65,
            "microPartialPoints": 3.0,
            "microPartialPct": 0.40,
            "timeLockSeconds": 75,
            "timeLockMinGain": 2.0,
            "grindProfitSeconds": 55.0,
            "grindProfitMinGain": 1.1,
