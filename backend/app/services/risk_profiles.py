...
def _scalp_acs_session_params(bucket: str, *, block_closing_momentum: bool = False) -> dict[str, Any]:
    ...
    defaults = {
        ...
        "breakevenShiftPoints": 2.0,
        "runnerArmPoints": 3.0,
        "runnerMinLockPoints": 1.75,
        "runnerRetainPct": 0.70,
        "runnerCapPoints": 9.0,
        "quickProfitPoints": 5.0,
        "partialExitPct": 0.65,
        "microPartialPoints": 2.0,
        "microPartialPct": 0.55,
        "timeLockSeconds": 55,
        "timeLockMinGain": 1.25,
        "grindProfitSeconds": 25.0,
        "grindProfitMinGain": 0.45,
        "staleGivebackPoints": 0.45,
    ...
    overrides: dict[str, dict[str, Any]] = {
        ...
        "OPEN_DRIVE": {
            ...
            "partialExitPct": 0.60,
            "microPartialPoints": 2.5,
            "microPartialPct": 0.50,
            "timeLockSeconds": 70,
            "timeLockMinGain": 2.0,
            "grindProfitSeconds": 45.0,
            "grindProfitMinGain": 1.0,
